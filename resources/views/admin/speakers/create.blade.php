        ...
        <form action="{{ route("admin.speakers.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <input 
                    ...
                    name="name" 
                    class="form-control" 
                    value="{{ old('name', isset($speaker) ? $speaker->name : '') }}" 
                    required
                    pattern="[ A-Za-záéíóú]+"
                    oninvalid="
                    if (this.value ===''){
            ...
            <div class="form-group {{ $errors->has('twitter') ? 'has-error' : '' }}">
                ...
                <input 
                    ...
                    value="{{ old('twitter', isset($speaker) ? $speaker->twitter : '') }}" 
            ...
            <div class="form-group {{ $errors->has('facebook') ? 'has-error' : '' }}">
                ...
                <input 
                    ...
                    class="form-control" 
                    pattern="[(http(s)?):\/\/(www\.)?a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)" 
                    value="{{ old('facebook', isset($speaker) ? $speaker->facebook : '') }}" 
            ...
            <div class="form-group {{ $errors->has('linkedin') ? 'has-error' : '' }}">
                ...
                <input 
                    ...
                    class="form-control" 
                    pattern="[(http(s)?):\/\/(www\.)?a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)" 
                    value="{{ old('linkedin', isset($speaker) ? $speaker->linkedin : '') }}"
