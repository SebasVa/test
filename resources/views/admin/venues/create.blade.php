        ...
        <form action="{{ route("admin.venues.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <input 
                    ...
                    name="name"
                    class="form-control" 
                    value="{{ old('name', isset($venue) ? $venue->name : '') }}" 
                    required
                    oninvalid="
                    if (this.value ===''){
            ...
            <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                ...
                <input 
                    ...
                    name="address" 
                    class="form-control" 
                    value="{{ old('address', isset($venue) ? $venue->address : '') }}" 
                    required
                    oninvalid="
                    if (this.value ===''){
                        this.setCustomValidity('Ingresa la dirección!')
                    }"
                    oninput="this.setCustomValidity('')"
                >
            ...
            <div class="form-group {{ $errors->has('latitude') ? 'has-error' : '' }}">
                ...
                <input 
                    ...
                    name="latitude" 
                    class="form-control" 
                    value="{{ old('latitude', isset($venue) ? $venue->latitude : '') }}" 
                    required
                    oninvalid="
                    if (this.value ===''){
                        this.setCustomValidity('Ingresa la latitud!')
                    }"
                    oninput="this.setCustomValidity('')"
                >
            ...
            <div class="form-group {{ $errors->has('longitude') ? 'has-error' : '' }}">
                ...
                <input 
                    ...
                    name="longitude" 
                    class="form-control" 
                    value="{{ old('longitude', isset($venue) ? $venue->longitude : '') }}" 
                    required
                    oninvalid="
                    if (this.value ===''){
                        this.setCustomValidity('Ingresa la longitud!')
                    }"
                    oninput="this.setCustomValidity('')"
                >
