        ...
        <form action="{{ route("admin.schedules.update", [$schedule->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('day_number') ? 'has-error' : '' }}">
                ...
                <input 
                    ...
                    name="day_number" 
                    class="form-control" 
                    value="{{ old('day_number', isset($schedule) ? $schedule->day_number : '') }}" 
                    step="1" 
                    required
                    oninvalid="
                    if (this.value ===''){
                        this.setCustomValidity('Ingresa el número de día!')
                    }"
            ...
            <div class="form-group {{ $errors->has('start_time') ? 'has-error' : '' }}">
                ...
                <input 
                    ...
                    oninvalid="
                    if (this.value ===''){
                        this.setCustomValidity('Ingresa la hora!')
                    }"
                    oninput="this.setCustomValidity('')"
                >
            ...
            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                ...
                <input 
                    ...
                    oninvalid="
                    if (this.value ===''){
                        this.setCustomValidity('Ingresa el título!')
                    }"
                    oninput="this.setCustomValidity('')"
                >
                @if($errors->has('title'))
            ...
            <div class="form-group {{ $errors->has('subtitle') ? 'has-error' : '' }}">
                ...
                <input 
                    ...
                    oninvalid="
                    if (this.value ===''){
                        this.setCustomValidity('Ingresa el subtítulo!')
                    }"
                    oninput="this.setCustomValidity('')"
                >
